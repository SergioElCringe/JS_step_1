const app = {
	...
	hearEvent(event) {
		...
		switch (buttonKey) {
			case 'AC': this.cleanAll(); break;
			case '0': this.addNum(0); break;
			case '1': this.addNum(1); break;
			case '2': this.addNum(2); break;
			case '3': this.addNum(3); break;
			case '4': this.addNum(4); break;
			case '5': this.addNum(5); break;
			case '6': this.addNum(6); break;
			case '7': this.addNum(7); break;
			case '8': this.addNum(8); break;
			case '9': this.addNum(9); break;
			case '.': this.addNum('.'); break;
			case 'del': this.addNum('del'); break;
			case '±': this.addNum('±'); break;
			case '+': this.addSign('+'); break;
			case '-': this.addSign('-'); break;
			case 'x': this.addSign('x'); break;
			case '/': this.addSign('/'); break;
			case '=': this.result(); break;
		}
	},
	...
	result() {
		...
		switch (this.mathSign) {
			case '+': this.firstNum = +this.firstNum + +this.secondNum; break;
			case '-': this.firstNum = +this.firstNum - +this.secondNum; break;
			case 'x': this.firstNum = +this.firstNum * +this.secondNum; break;
			default: if (this.secondNum !== '0') {
				this.firstNum = +this.firstNum / +this.secondNum; break;
			} else {
				this.firstNum = 'Error';
